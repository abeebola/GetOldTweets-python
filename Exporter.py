...
if sys.version_info[0] < 3:
    ...
    from got.manager.TweetManager import TweetManager
else:
    from got3.manager.tweetmanager import TweetManager
    from got3.manager.tweetcriteria import TweetCriteria
